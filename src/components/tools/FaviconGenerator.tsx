...
// Deduplicate while preserving order (some emoji appear in multiple category blocks)
const EMOJI_PICKER_OPTIONS = [...new Set(POPULAR_EMOJIS)];
    ...
    <div className="space-y-8">
      ...
      {mode === "emoji" && (
        <ToolPanel title="Emoji favicon settings">
          ...
          <div className="mb-4 max-h-72 overflow-y-auto rounded-lg border border-zinc-200 p-2 dark:border-zinc-700">
